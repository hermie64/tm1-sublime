...
2. I’m currently investigating the options to incorporate a Python-based interface to the TM1 REST API as a Sublime Text plugin, see https://github.com/MariusWirtz/TM1py).  
